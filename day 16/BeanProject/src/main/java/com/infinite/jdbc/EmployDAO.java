...
public class EmployDAO {
	...
	public String UpdateEmploy(Employ employNew) throws ClassNotFoundException,
	SQLException{
	...
	public String deleteEmploy(int empno) throws ClassNotFoundException,
	SQLException{
	...
	public String addEmploy(Employ employ) throws ClassNotFoundException,
	SQLException{
		connection = ConnectionHelper.getConnection();
	...
	public List<Employ> showEmploy() throws ClassNotFoundException,
	SQLException{
